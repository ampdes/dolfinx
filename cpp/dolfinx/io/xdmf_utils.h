...
/// array
std::vector<double>
get_point_data_values(const fem::Function<double, double, double>& u);
std::vector<std::complex<double>> get_point_data_values(
    const fem::Function<std::complex<double>, double, double>& u);

/// Get cell data values as a flattened 2D array
std::vector<double>
get_cell_data_values(const fem::Function<double, double, double>& u);
std::vector<std::complex<double>> get_cell_data_values(
    const fem::Function<std::complex<double>, double, double>& u);
